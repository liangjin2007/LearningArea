...
| 06 | Animating Blendshape Faces by Cross-Mapping Motion Capture Data | USC | ----- | ---------- | -------- | cross-mapping between motion capture data and target blendshape faces. 具体做法为RBF, ![faceanimation2](https://github.com/liangjin2007/data_liangjin/blob/master/faceanimation2.JPG?raw=true) | 半自动技术 |
