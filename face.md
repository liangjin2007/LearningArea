...
| 11 | Real-time Avatar Animation from a Single Image | Saragih | 输入：图像 / 输出: | ---------- | -------- | ---------- | 看着：质量不太好 |
...
| 15 | Displaced Dynamic Expression Regression for Real-time Facial Tracking and Animation | K.Zhou | ----- | ---------- | -------- | ---------- | -- |
