...
| 12 | Facial animation retargeting framework using radial basis functions | Hungary | ----- | ---------- | -------- | Maya ![RBF](https://github.com/liangjin2007/data_liangjin/blob/master/RBF.JPG?raw=true) | -- |
